 ...
 * 
 */
@WebServiceClient(name = "PhoneServiceService", targetNamespace = "http://phone.service.web.com/", wsdlLocation = "http://127.0.0.1:8888/ws/phoneService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName PHONESERVICESERVICE_QNAME = new QName("http://phone.service.web.com/", "PhoneServiceService");
    ...
    public PhoneService getPhoneServicePort() {
        return super.getPort(new QName("http://phone.service.web.com/", "PhoneServicePort"), PhoneService.class);
    }
    ...
    public PhoneService getPhoneServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://phone.service.web.com/", "PhoneServicePort"), PhoneService.class, features);
    }
