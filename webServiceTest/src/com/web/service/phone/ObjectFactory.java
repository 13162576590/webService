 ...
 * generated in the com.web.service.phone package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetPhoneInfo_QNAME = new QName("http://phone.service.web.com/", "getPhoneInfo");
    private final static QName _GetPhoneInfoResponse_QNAME = new QName("http://phone.service.web.com/", "getPhoneInfoResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.web.service.phone
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://phone.service.web.com/", name = "getPhoneInfo")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://phone.service.web.com/", name = "getPhoneInfoResponse")
